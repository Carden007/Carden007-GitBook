...
3、网速，即将进入5G第五代通讯信息技术，移动传输完全媲美PC，毫无卡顿，无需压缩，不会延迟，360全景视频，网络进一步加快，全景相机的普及第一步就是旅游直播，室内全景直播，实在缺乏想象力（雨）
...
32枚金币时间管理法：“早上7点起床，晚上11点睡觉，一共16个小时，把它按每半小时分开，分成32块，就有了32枚金币了。开开心心地玩了，是绿色；高效工作了，是黄色；无限制地刷微博、刷朋友圈啊，你就把它标成红色。这么一来，你会发现，一天的时间，红红绿绿，高效与不高效，一目了然。” 虚幻的时间用实在的表格记录下来，能帮助人更高效地管理时间，给人带来实实在在的改变，而这改变累积起来就是成功。建议做完一件事，就在表格里填上相应的颜色，随做随记录，这样效果最好。然后每周可以用excel出一张时间管理的饼状图，看高效工作和无效拖延占了多少百分比，为下一周树立奋进的目标。

* ## 产品价值

总述：时间规划的工具本质在于通过统计的数据启发用户思考自己的工作方式是否高效，进而更好地安排时间资源和精力资源。“不善于支配时间的人，经常都感到时间不够用”，这一句话具有相当的真实性。但是，怎么样才能高效利用有限的时间和精力呢?这是一个很高深的问题。下面正文：

1、个人效率应用将时间货币化，记账本已经很美，何况时间！当时间分成块，时间块再赋予内涵，培养用户对时间的感觉，将时间的货币价值铭记于心中，记录花销，真正高效利用每一块时间。时间的可视化，更让每一块时间形象呈现，每日的成长与进步一览无余。应用更可以将虚拟的时间金币与第三方网购平台进行合作，成为真正有购买力的人民币。真正让时间的货币化概念融入用户的血液里。（反正玩APP还能赚钱，我肯定下载，你推广，我赚钱！共同构建和谐社会）

2、发挥软件的长处，记录用户的时间节奏！通过应用的记录和数据统计，统计用户最多能集中多长时间注意力，从而找到适合相应用户的时间安排表。而不是随着用户的性子，随意制定工作计划和任务安排，控制好节奏才能让效率更高。当然，建立节奏并不是让用户做一个机器人，而是培养用户能够随时集中注意力和长时间集中注意力的能力。就这一个根据用户特点推荐不同计划安排的功能就可以秒杀市场的一切工作计划类应用。当然，制定工作计划不仅仅是设置时限，还有排列任务顺序，根据用户的节奏合理分配精力，在精力最充沛的时间内完成一天内最重要的事。还有，再忙也要喝杯热荼，工作之后总要进行放松和享受。

3、效率应用帮助用户自我检讨和自我改进。应用根据用户的点滴记录自动生成日回顾、周回顾、月回顾来引导用户自我反思。大多数的时间管理方法都会谈到每年、每半年、每月、每周、每日的目标或清单之间的差异，对于用户来说，那未免过于复杂和沉重了。定期总结是个人成长和避免错误的最好方法之一，多分析多总结才能让自己提高的更多，能在这份总结里，清晰的了解自己的时间花在哪了，哪里可以改进。3年工作经验，有的人是做同样的事情重复了3年，有的人是不断的总结，一直在改进自己的办法和效率，你想做哪种？

4、应用帮助用户集中注意力，迅速找到工作学习最佳的状态。主要原则在于一个人需要通过记录的方式把头脑中的各种任务移出来。通过这样的方式，头脑可以不用塞满各种需要完成的事情，而集中精力在正在完成的事情。心无旁骛！就是这种感觉。

5、应用让用户清晰地感受到自己距离目标还有多远。很多时候人坚持不下去的根本原因不是因为你不努力，而是你努力了很久很久却依然看不到胜利的曙光。众所周知，每一个上进的人都曾有非常热血想要一下子学习到天亮的时候，关键是很难保持，这就是个人用户的最大痛点，而效率应用将帮助用户在大脑的世界里战胜懒惰，以科学循序渐进的方式为你的激情找到喷发的出口和持久的动力。简单的说，就是不用你卧薪尝胆，但依然给你一个可持续发展的动力。输赢就存在于你每天选择要做的事情和不做的事情，这也就决定了你能够向你的目标迈进多大的一步，所以你需要有一份每日任务的清单。而这，效率应用早已经为你定制！

6、应用帮助用户培养一种良好习惯，比如写日记。可以预先定义某一枚特定的金币必须用于做特定的事情，然后每日准时提醒。很多人的问题在于：人们已经明确告诉自己想要培养一个好习惯，却总是在每天该干此事的时候沉迷于其它事情，就是放纵，事后又反悔，应用每日提醒，引入积分机制，少一天也不行，否则过去的所有积分归零，只能重头再来。每天走一点点，总有一天，你会发现，曾经被你视为艰难挑战的高峰，也只不过是你生命里的小山丘。

7、应用帮助用户克服拖延症。管理时间，不仅仅是管理我们的生活，更是反映了我们对于人生的态度与整个人生的看法。这不同于一个任务的时间管理类，更多地是一种糅合日历的提醒功能，时间很明确，任务也很明确，应用要做的仅仅是在特定的时间对用户进行有杀伤力的提醒。要想做持久的改变，我们必须确定一步步的仪式。如有不从，后果自负，出来混，迟早都是要还的。

8、应用可以激发用户对于工作的激情。当用户选择或自定义一个任务后，系统会自动搜索数据库告诉用户曾经有人完成一模一样的用户只需要几枚硬币（假设一枚硬币代表30分钟），然后询问用户是否想要刷新记录，然后计时开始，激发用户的求胜欲望。当然最大的问题在于，如果用户执行的是非数字化的工作任务，应用该如何判断任务的完成度？将任务完成效率进行排名？

9、应用每日推送给用户高效的学习方法和工作方法。将相关主题的书籍和其它用户的分享推送到每一个用户。作为个人用户，只要应用真正提供的信息能够让我学得更快学得更好，拥有别人没有的小技巧，那么我就会去下载使用他！即使除此之外其它啥功能也没有。

* ## 思考瓶颈

1、本应用的用户在设置任务时需要精确到具体时间界限，但实际上不可能精确，事情都是一件做完才开始做下一件的？能做的也就仅仅是安排大致开始的时间段罢了！

2、本应用通过统计用户的数据可以找到用户的时间节奏，能够建议用户多少时间干多少事？可是如何才能抓取到用户的每日的精力曲线，智能推荐用户先做哪件事，后做哪件事呢？

3、用户发布了任务但是事实上并没有完成了，如何激励用户和帮助用户改进？且不会使得用户因此产生挫败感？做一个高情商的心灵应用！

4、传统的任务清单都是根据事情的轻重缓急来进行排序，但我觉得这并不绝对，因为有许多说不清道不明的排序策略，更应该给用户一种排序策略，智能推荐用户参考自己的精力曲线，选择在最适合做这件事情的时候去做这件事，而不是等到不适合的时候去做这件事，这样才是最高效的？而发掘用户的精力曲线正好时应用软件所擅长的！春哥，你说呢？

* ## 解决问题

问题1：很多人的微信，QQ上或许都有几个工作相关的群组。但是，用微信、QQ等及时通信类类软件谈论公事，真的是一个有效率的做法吗？很明显，不是。通常出现的困惑就是：“每次用微信群组讨论事情，大家总是有一搭没一搭的回应，搞到最后提问的人很脑很焦虑，却还是一是无成。用社交软件讨论工作普遍没效率，究其根本，我认为在于旁观者效应，讨论组的人总以一种旁观的心态看待讨论，心里认为领导提的问题，总会有积极分子去说，我看着就好，只要我们的效率应用能创新讨论的气氛，培养一种我有责任去激烈讨论的用户心理，时刻让员工感觉提出问题的人在用期待的眼神看着自己，那么这种挖掘了特定痛点的创新应用，必然大市场，甚至有时候，创新的点不必太多，只要抓住一个痛点深入深入再深入，必然一片大天地，切忌盲目的、泛而不深的创新。就像当初的陌陌，凭什么能突破重重包围，就因为那时候使用QQ和微信不能添加附近的人。但往往我们最想交流的人就是那些有机会能够真实见面的人，过往有很多千里迢迢见网友的事情发生，这说明每个花费巨大精力去聊天的人都不傻，都幻想自己能聊到一定程度就能水道渠成，真正只聊天没有其他想法的人太少了，我就不明白了，当QQ看到很多人千里迢迢见去网友的新闻为什么就没有一丁点儿的想法呢？结果还是微信模仿陌陌，基于LBS的交友，只能说，微信当初要不是有这个功能，真跟QQ没啥本质的区别，电脑端和移动端总要一点体现区别吧？移动端的最大亮点就在于它可以移动。从这个角度出发去思考，我们就可以明白为啥会诞生某些应用，又为啥会火了！所以，团队最大的痛点就在于旁观者效应。值得深思，不止是讨论，经常高中老师热血沸腾的提了问题，结果没同学回应就是这个感觉。同学们总会倾向于认为其他同学可能会对老师做出回应，因此分散了每个人自认为所应该负起的责任。所以总结就是：除了大家都能想到的提升效率的方式，一是大多数效率应用帮助团队明确计划任务，少数效率应用还能帮助团队建立清晰的工作目标，而市场很少很少几乎没有效率应用还能帮助团队明确责任，这就是我们的机会。

问题2：每个公司干得最没效率的事情就是开会，但是很多聪明人就还是不得不去开会。有时候甚至仅仅是因为领导想要了解下属的任务进展。但是A向领导汇报自己情况的时候。其余的B、C、D、E、F全没什么事情可干。同理当B汇报的时候也是这样。而且会议的很多议题和内容的安排还需要秘书，为什么不通过效率应用直接连通会议负责人和参会者呢？互联网时代，领导和下属的直接连接已经事情不再非秘书不可！每周的例会和工作汇报也未必能反映真实的工作状态，真的是让员工和老板都有意见但又都离不开。其中很有问题呀，值得深思！

问题3：自动帮老板督促员工更顺利的完成工作，现在同类型的团队协作软件（还没时间认真体验，后期深入分析），诸如云之家、teambition、明道、盯盯工作等。柑橘功能多，没重点，就是春哥你说的没抓住痛点，更多的是站在老板的角度让老板知道员工更多的信息罢了，但痛点根本不再这儿呀，而在于能够真正地提升员工之间协作效率，这才是一款效率应用最应该去思考的地方，而不是一味地去讨好老板。只是讨好老板而不能提高团队效率的的APP注定失败，因为效率应用的用户都定位错了，我们的目标是：”既能让老板省心舒心，又会让员工们觉得我们的效率应用真正能够为他们团队协同工作创造价值“。
